...
function search(){
    ...
    $.get(
        "https://www.googleapis.com/youtube/v3/search", {
            ...
            q: q,
            type: 'video',
            key: 'AIzaSyADyIM2z-dTOvi7aiVgQJT6NRQTSi1sPSk'
        },
        function(data){
...
function getOutput(item){
    ...
    '<h3> <a class="fancybox fancybox.iframe" data-type="iframe" data-fancybox href="http://www.youtube.com/embed/'+videoId+'">'+title+'</a></h3>' +
